...
# useful packages (continued)- `brew install noahgorstein/tap/jqp`, pyenv, jid, csvkit, gsed, ntfy, zed, pandoc, basictex, openapi-tui, canvas, excalidraw_export, woff2, pdf-tools(in emacs)
# cmake
